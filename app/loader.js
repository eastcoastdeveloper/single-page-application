            ...
            var interceptor = [
                ...
                function(
                    ...
                    function isCached(config) {
                        ...
                        var cached =
                            cache !== undefined
                                ? cache.get(config.url) !== undefined
                                : false;
                    ...
                    return {
                        request: function(config) {
                            if (!config.ignoreLoadingBar && !isCached(config)) {
                                ...
                                // console.log(reqsTotal + " requests made. Loader successful");
                            }
                            return config;
                        },
                        ...
                        response: function(response) {
                            ...
                            if (
                                !response.config.ignoreLoadingBar &&
                        ...
                        responseError: function(rejection) {
                            ...
                            if (
                                !rejection.config.ignoreLoadingBar &&
        ...
        this.$get = [
            ...
            function($injector, $document, $timeout, $rootScope) {
                ...
                function _start() {
                    ...
                    var $after =
                        parent.lastChild && angular.element(parent.lastChild);
